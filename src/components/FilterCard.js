        ...
        return (
            <div className="card card-container filter">
                <div className="card-body">
                    <h2 className="h6 mb-2">Filter by Stock Symbol:</h2>
                    { 
                        ...
                        : <p className="mb-0 no-filter-message">No Stock Symbol to Filter. Please search stock code for more details</p>
                    }
                </div>
            </div>
        );
